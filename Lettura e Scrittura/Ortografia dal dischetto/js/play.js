var playState = {
	...
	create:function(){
		...
		uno = game.add.sprite(100, 300, gruppo_sprite[gruppo_ort]);
		due = game.add.sprite(480, 300, gruppo_sprite[gruppo_ort]);	
...
fischio.play();}
	...
	setRisposte:function(){
		...
		uno.animations.frame = risposte[current]*2;
		due.animations.frame = risposte[current]*2+1;
 ...
 getRandomInt:function(min, max) {
  ...
  return Math.floor(Math.random() * (max - min)) + min;
	...
	noGoal:function(){
		...
		testoparolaesatta = "La parola esatta era " + parole_gruppi[gruppo_ort][risposte[current]];
		bar.visible = true;
