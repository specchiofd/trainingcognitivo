var loadState = {
	...
	preload:function(){
		...
		game.load.spritesheet('sce', 'assets/scea.png', 200, 75);
		game.load.spritesheet('scischi', 'assets/schisci.png', 200, 75);
		game.load.spritesheet('ligli', 'assets/ligli.png', 200, 75);
		game.load.spritesheet('nigni', 'assets/nigni.png', 200, 75);
		game.load.spritesheet('cuqu', 'assets/cuqu.png', 200, 75);
		game.load.spritesheet('doppie', 'assets/doppie.png', 200, 75);
		game.load.spritesheet('cichi', 'assets/cichi.png', 200, 75);
		game.load.spritesheet('gighi', 'assets/gighi.png', 200, 75);
		...
		game.load.spritesheet('sce', 'assets/sce.png', 200, 75);
