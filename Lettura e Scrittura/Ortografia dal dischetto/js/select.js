var selectState = {
		...
		up.events.onInputDown.add(this.up_change,this);
		down.events.onInputDown.add(this.down_change,this);
		...
		text_three = game.add.text(0, 100, gruppi[gruppo_ort], {
        font: "40px Arial",
        fill: "#ffffff",
	...
	up_change:function(){
		gruppo_ort -= 1;
		if(gruppo_ort <0){
			gruppo_ort = gruppi.length-1;
		}
		text_three.setText(gruppi[gruppo_ort]);
		
	},
	
	down_change:function(){
				gruppo_ort += 1;
				console.log(gruppo_ort);
		if(gruppo_ort == gruppi.length){
			gruppo_ort = 0;
		}
		text_three.setText(gruppi[gruppo_ort]);
	},
